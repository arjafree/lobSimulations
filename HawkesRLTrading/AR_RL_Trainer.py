...
log_dir = '/home/ajafree/LSTM_fRL/wout_expo/no_double_quoting_bonus/gae_lambda/training/sell/logs/'
model_dir = '/home/ajafree/LSTM_fRL/wout_expo/no_double_quoting_bonus/gae_lambda/training/sell/model'
...
for episode in range(80):
    ...
    twap_side = "sell"  # sell-only run (was: np.random.choice(["buy", "sell"]))
