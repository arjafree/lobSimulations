...
log_dir = '/home/ajafree/LSTM_fRL/wout_expo/new_value_function/sell/logs/'
model_dir = '/home/ajafree/LSTM_fRL/wout_expo/new_value_function/sell/model'
...
RLagentInstance = AdversarialPPOAgent( seed=1, log_events=True, log_to_file=True, strategy=j["strategy"], Inventory=j["Inventory"], cash=j["cash"], action_freq=j["action_freq"],
                          ...
                          gae_lambda=0.5, gamma=0.99, truncation_enabled=False, action_space_config = 1, alt_state=True, enhance_state=True, include_time=True, optim_type='ADAM',entropy_coef=0, exploration_bonus = 0, hidden_activation='sigmoid',
