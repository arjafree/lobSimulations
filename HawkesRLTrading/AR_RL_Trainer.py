...
log_dir = '/home/ajafree/LSTM_fRL/wout_expo/bugfixes/no_termpen/sell/training/logs/'
model_dir = '/home/ajafree/LSTM_fRL/wout_expo/bugfixes/no_termpen/sell/training/model'
...
RLagentInstance = AdversarialPPOAgent( seed=1, log_events=True, log_to_file=True, strategy=j["strategy"], Inventory=j["Inventory"], cash=j["cash"], action_freq=j["action_freq"],
                          ...
                          typeNN = "LSTM", lr = 3e-4, chunk_length=64, TWAPPresent=0, cem_full_episode=True, terminal_invpenalty=0)
